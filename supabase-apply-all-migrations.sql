-- ============================================================
-- Pro Acc — تطبيق جميع المايجريشنز المعلقة (007 → 043)
...
-- ==================== 042-additional-missing-tables.sql ====================
-- ============================================================
...
INSERT INTO _migrations (filename) VALUES ('042-additional-missing-tables.sql') ON CONFLICT (filename) DO NOTHING;

-- ==================== 043-app-settings.sql ====================
-- ============================================================
...
INSERT INTO _migrations (filename) VALUES ('043-app-settings.sql') ON CONFLICT (filename) DO NOTHING;

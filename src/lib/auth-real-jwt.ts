// @deprecated مهمل وغير مستخدم حالياً (٠ استيراد). النظام الحي للمصادقة هو src/lib/auth.ts عبر requireApiAuth في src/lib/api-helpers.ts.
// هذا الملف محتفظ به كمرجع فقط — لا تربطه بأي مسار برمجي مستقبلاً لتجنّب الارتباك.
/**

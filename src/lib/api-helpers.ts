...
const ACCOUNTING_RPC_MESSAGES: ReadonlySet<string> = new Set([
  ...
  'بيانات التحويل غير صالحة', 'لا يمكن التحويل إلى نفس الخزينة',
  'الخزينة المصدر غير موجودة', 'الخزينة الوجهة غير موجودة', 'الرصيد غير كاف للتحويل',
  'لا يمكن إلغاء سلفة الموظف بعد تسديد جزء منها',
  'تعذر تطبيق تخصيص فاتورة البيع', 'تعذر تطبيق تخصيص فاتورة الشراء',

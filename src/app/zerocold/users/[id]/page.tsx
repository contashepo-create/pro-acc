...
export default function UserProfilePage() {
  ...
  const statusColors: Record<string, string> = {
    active: 'bg-emerald-950/40 text-emerald-400 border-emerald-800/30',
    inactive: 'bg-gray-800/40 text-gray-400 border-gray-700/30',
    cancelled: 'bg-red-950/40 text-red-400 border-red-800/30',
  };
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          {user.is_active ? (
            <span className="px-3 py-1 rounded-full bg-emerald-950/40 text-emerald-400 border border-emerald-800/30 text-sm flex items-center gap-1">
              <CheckCircle size={14} /> نشط
            </span>
          ) : (
            <span className="px-3 py-1 rounded-full bg-gray-800/40 text-gray-400 border border-gray-700/30 text-sm flex items-center gap-1">
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between items-start">
              ...
              <span className={`px-2 py-1 rounded-full text-xs border ${
                user.company.is_active ? 'bg-emerald-950/40 text-emerald-400 border-emerald-800/30' : 'bg-red-950/40 text-red-400 border-red-800/30'
              }`}>

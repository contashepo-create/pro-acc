          ...
          <div className="space-y-5">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                ...
                <Input type="number" value={form.amount} onChange={(e)=>setForm({...form, amount: (e.target as HTMLInputElement).value})} />
              </div>
              <div>
              ...
              <div>
                ...
                <Input type="time" value={form.time} onChange={(e)=>setForm({...form, time: (e.target as HTMLInputElement).value})} />
              </div>
            </div>
            ...
            <div>
              ...
              <Input placeholder="https://..." value={form.receipt_url} onChange={(e)=>setForm({...form, receipt_url: (e.target as HTMLInputElement).value})} />
            </div>

            <div>
              <label className="text-xs text-text-muted">ملاحظات إضافية</label>
              <textarea value={form.notes} onChange={(e)=>setForm({...form, notes: (e.target as HTMLTextAreaElement).value})} className="w-full mt-1 px-3 py-2 bg-bg-secondary border border-border rounded-xl text-sm h-20" placeholder="اكتب تفاصيل إضافية..."></textarea>
            </div>
